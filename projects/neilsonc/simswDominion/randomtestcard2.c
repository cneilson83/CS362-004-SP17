...
int main(){
	...
	int i, j, numPlayers, randC, newCards = 0, discardedCard = 0, newActions = 0, thisPlayer, otherPlayer, changes = 0;
	int seed = 1000, handPos = 0, choice1 = 0, choice2 = 0, choice3 = 0, bonus = 0;
